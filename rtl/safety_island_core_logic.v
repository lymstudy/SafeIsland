...
(
    ...
    assign cfg_illegal_out        = cfg_illegal | cfg_table_fault_comb;
    ...
    assign core_safety_fault       = safety_fault_comb | safety_fault_stable_comb;
    assign core_safety_error_code  = (safety_error_code_comb != ERR_NONE) ?
                                     safety_error_code_comb : safety_error_code_q;
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (clear_core_status) begin
                ...
                // Error code is sticky: only update when no previous safety fault
                if (!safety_fault_q) begin
